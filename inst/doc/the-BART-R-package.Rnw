...
\author{Nicholas C. Henderson \\University of Michigan
\And Mahsa Ashouri \\ Miami University}
\Plainauthor{Nicholas C. Henderson, Mahsa Ashouri}
...
\title{The \pkg{rmstbart} \proglang{R} package}
